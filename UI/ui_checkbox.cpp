...
UI_checkbox::UI_checkbox(QObject *parent) : UI_item(UI_enum::ui_checkbox, parent), m_checked()
{
}

UI_checkbox::UI_checkbox(std::string text, Color fg_color, Color bg_color, QObject *parent)
    : UI_item(UI_enum::ui_checkbox, text, fg_color, bg_color, parent), m_checked(false)
{
}
