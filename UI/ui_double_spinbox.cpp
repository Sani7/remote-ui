...
UI_double_spinbox::UI_double_spinbox(QObject *parent) : UI_item(UI_typeGadget::UI_type::ui_double_spinbox, parent)
{
    m_ui_item.setSpinbox(UI_spinbox_m());
}

UI_double_spinbox::UI_double_spinbox(double min, double max, double value, QObject *parent)
    : UI_item(UI_typeGadget::UI_type::ui_double_spinbox, parent)
{
    m_ui_item.setSpinbox(UI_spinbox_m());
