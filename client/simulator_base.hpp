...
class Simulator_base : public QMainWindow
{
  ...
  protected:
    ...
    virtual void process_ui_label(json &ui_item);
    virtual void process_ui_slider(json &ui_item);
    virtual void process_ui_dial(json &ui_item);
    virtual void process_ui_thermo(json &ui_item);
    virtual void process_ui_textbox(json &ui_item);
    virtual void process_ui_combobox(json &ui_item);
    virtual void process_ui_radiobutton(json &ui_item);
    virtual void process_ui_checkbox(json &ui_item);
    virtual void process_ui_button(json &ui_item);
    virtual void process_ui_led(json &ui_item);
    virtual void process_ui_plot(json &ui_item);
    virtual void process_ui_table(json &ui_item);
    virtual void process_ui_can(json &ui_item);
